...
/* package day05b-0.1.0.0 */
#define VERSION_day05b "0.1.0.0"
#define MIN_VERSION_day05b(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "day05b-0.1.0.0"

#define CURRENT_PACKAGE_KEY "day05b-0.1.0.0"
