...
/* package day06b-0.1.0.0 */
#define VERSION_day06b "0.1.0.0"
#define MIN_VERSION_day06b(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "day06b-0.1.0.0"

#define CURRENT_PACKAGE_KEY "day06b-0.1.0.0"
